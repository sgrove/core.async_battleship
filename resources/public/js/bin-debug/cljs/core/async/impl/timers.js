...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3443__auto__,writer__3444__auto__,opt__3445__auto__){return cljs.core._write.call(null,writer__3444__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_7165 = 0;while(true){
if((i_7165 < arr.length))
{(arr[i_7165] = null);
{
var G__7166 = (i_7165 + 1);
i_7165 = G__7166;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3443__auto__,writer__3444__auto__,opt__3445__auto__){return cljs.core._write.call(null,writer__3444__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_7172 = (self__.level + 1);while(true){
if((i_7172 <= (new_level + 1)))
{(update[i_7172] = self__.header);
{
var G__7173 = (i_7172 + 1);
i_7172 = G__7173;
continue;
}
} else
...
{var i_7174 = 0;while(true){
if((i_7174 <= self__.level))
{var links_7175 = (update[i_7174]).forward;if(((links_7175[i_7174]) === x__$1))
{(links_7175[i_7174] = (x__$1.forward[i_7174]));
{
var G__7176 = (i_7174 + 1);
i_7174 = G__7176;
continue;
}
} else
{{
var G__7177 = (i_7174 + 1);
i_7174 = G__7177;
continue;
}
}
